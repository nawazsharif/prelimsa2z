<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="{{route('student.dashboard')}}" class="brand-link">
        <span class="brand-text font-weight-light">{{ trans('PRELIMSA2Z') }}</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                    ...
                    <li class="nav-item">
                        <a href="{{ route("admin.quizzes.index") }}" class="nav-link {{ request()->is("admin/quizzes") || request()->is("admin/quizzes/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-cogs">
