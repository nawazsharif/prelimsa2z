        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_verified') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_verified" id="is_verified" value="1" {{ $user->is_verified || old('is_verified', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_verified">{{ trans('cruds.user.fields.is_verified') }}</label>
                </div>
