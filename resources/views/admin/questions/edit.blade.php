        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.questions.update", [$question->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('quiz') ? 'is-invalid' : '' }}" name="quiz_id" id="quiz_id" required>
                        @foreach($quizzes as $id => $entry)
                            <option value="{{ $id }}" {{ (old('quiz_id') ? old('quiz_id') : $question->quiz->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('quiz'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('choice_1') ? 'is-invalid' : '' }}" type="text" name="choice_1" id="choice_1" value="{{ old('choice_1', $question->choice_1) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('choice_2') ? 'is-invalid' : '' }}" type="text" name="choice_2" id="choice_2" value="{{ old('choice_2', $question->choice_2) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('choice_3') ? 'is-invalid' : '' }}" type="text" name="choice_3" id="choice_3" value="{{ old('choice_3', $question->choice_3) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('choice_4') ? 'is-invalid' : '' }}" type="text" name="choice_4" id="choice_4" value="{{ old('choice_4', $question->choice_4) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('answer') ? 'is-invalid' : '' }}" type="text" name="answer" id="answer" value="{{ old('answer', $question->answer) }}" required>
