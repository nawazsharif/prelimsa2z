        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.quizzes.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('question_lenth') ? 'is-invalid' : '' }}" type="number" name="question_lenth" id="question_lenth" value="{{ old('question_lenth', '') }}" step="1" required>
